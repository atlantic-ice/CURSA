...
> Текущая активная версия репозитория ориентирована на дипломный контур: проверка, отчёт, автокоррекция, профили нормоконтроля, история и воспроизводимый запуск. Платёжный и коммерческий контур не входит в актуальный scope продукта.
...
**Текущий фокус (дипломная версия):**

- Стабилизация DOCX workflow: загрузка → проверка → отчёт → автокоррекция → выгрузка
- Консолидация профилей нормоконтроля и сценариев проверки
- Повышение воспроизводимости тестов, сборки и демонстрационного запуска
