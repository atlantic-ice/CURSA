  ...
  const mainMenuItems = [
    {
      ...
      icon: (isActive, isHover) => (
        <BarChartIcon fontSize="small" sx={sidebarIconSx(isActive || isHover)} />
      ),
    },
    {
      id: "upload",
      label: "Загрузить",
      icon: (isActive, isHover) => (
        <FolderIcon fontSize="small" sx={sidebarIconSx(isActive || isHover)} />
      ),
    },
    {
      id: "materials",
      label: "Материалы",
      icon: (isActive, isHover) => (
        <MenuBookIcon fontSize="small" sx={sidebarIconSx(isActive || isHover)} />
      ),
    },
    {
      id: "assignments",
      label: "Задания",
      icon: (isActive, isHover) => (
        <DescriptionIcon fontSize="small" sx={sidebarIconSx(isActive || isHover)} />
      ),
    },
  ];
  ...
  const preferencesItems = [
    {
      ...
      label: "Команда",
      icon: (isActive, isHover) => (
        <GroupIcon fontSize="small" sx={sidebarIconSx(isActive || isHover)} />
      ),
    },
    {
      id: "settings",
      label: "Настройки",
      icon: (isActive, isHover) => (
        <SettingsIcon fontSize="small" sx={sidebarIconSx(isActive || isHover)} />
      ),
    },
  ];
  ...
  const otherItems = [
    {
      ...
      label: "Уведомления",
      icon: (isActive, isHover) => (
        <NotificationsNoneIcon fontSize="small" sx={sidebarIconSx(isActive || isHover)} />
      ),
    },
    {
      id: "help",
      ...
      icon: (isActive, isHover) => (
        <HelpOutlineIcon fontSize="small" sx={sidebarIconSx(isActive || isHover)} />
      ),
    },
  ];
      ...
      <Box sx={{ px: 2, pt: 2.5, pb: 2 }}>
        <Box sx={{ display: "flex", alignItems: "center", gap: 0.5 }}>
          <Typography
            ...
            variant="subtitle1"
            sx={{ color: "#fff", fontWeight: 600, fontSize: "1rem", letterSpacing: "-0.02em" }}
          >
            Cursa
          </Typography>
        </Box>
