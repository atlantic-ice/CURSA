new_header = r"""import ArrowOutwardIcon from "@mui/icons-material/ArrowOutward";
    ...
    >
      <Box sx={{ display: "flex", alignItems: "center", justifyContent: "space-between", mb: 6 }}>
        ...
        <IconButton
          ...
          sx={{ color: "rgba(255,255,255,0.4)", p: 0.5, "&:hover": { color: "#fff", bgcolor: "transparent" } }}
        >
        ...
        <Box sx={{ display: "flex", alignItems: "center", gap: 1.5, ml: "auto" }}>
          {!isMobile && (
            <Button
              ...
              sx={{
                ...
                py: 0.5,
                minHeight: 32,
                "&:hover": { borderColor: "rgba(255,255,255,0.4)", color: "#fff", bgcolor: "rgba(255,255,255,0.04)" },
              }}
            >
              Войти
            </Button>
          ...
          {isMobile && (
            <IconButton
              ...
              sx={{ color: "rgba(255,255,255,0.6)", p: 0.75, "&:hover": { color: "#fff", bgcolor: "transparent" } }}
            >
